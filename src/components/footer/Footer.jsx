        ...
        <footer className="bg-primary text-white py-8 pb-0 text-base lg:text-sm">
            ...
            {!isMobile && (
                <div className="container mx-auto px-6 lg:px-28 flex flex-col lg:flex-row justify-between items-center lg:items-start">
                    ...
                    <div className="mt-6 mb-8 lg:mt-0 text-center lg:text-left">
                        ...
                        <li><a href="#kategori" className="">Kategori</a></li>
                        <li><a href="/katalog" className="">Katalog</a></li>
                        </ul>
                    </div>
                    {/* bagian menu */}
                    ...
                    <div className="mt-6 lg:mt-0 text-center lg:text-left">
                        ...
                        <li className="flex items-center gap-2 justify-center lg:justify-start">
                                ...
                                >
                                    ...
                                    <span className="align-middle">0882003826565</span>
                                </a>
                            </li>
                            <li className="flex items-center gap-2 justify-center lg:justify-start">
                                <a 
                                ...
                                >
                                    ...
                                    <span className="align-middle">sumadi.679727</span>
                                </a>
                            </li>
                            <li className="flex items-center gap-2 justify-center lg:justify-start">
                                <a 
                                ...
                                >
                                    ...
                                    <span className="align-middle">sumadisumadi8655</span>
                                </a>
                            </li>
                        </ul>
                    </div>
            ...
            {/* copyright */}
                <div className="bg-black text-center text-white py-4 mt-4">
                    <p className="text-sm">
                        Copyright © 2025 <a href="#" className="text-blue-400 ">Tambah Barokah</a>. All rights reserved.
                    </p>
                </div>
            </footer>
    );
