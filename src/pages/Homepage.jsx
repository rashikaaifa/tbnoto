...
const Homepage = () => {
	const [currentPoster, setCurrentPoster] = useState(0); // untuk section poster
	...
	const handleSubmit = async (e) => {
		...
		try {
			const response = await fetch(
				'https://tbnoto19-admin.rplrus.com/api/faq',
				{
					method: 'POST',
					headers: {
					...
					<div className="grid grid-cols-1 md:grid-cols-2 gap-10 items-center">
						...
						>
							...
							<p className="text-lg leading-relaxed">
								Berawal dari masa sulit saat pandemi Covid-19,
								kami kembali ke kampung halaman dan memulai
								usaha toko bangunan. Dari pencarian supplier ke
								berbagai pabrik, kami menemukan peluang besar di
								produk triplek dan menjadikannya fokus utama
								toko. Dengan nama{' '}
