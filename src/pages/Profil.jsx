...
const ProfilePage = () => {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      reader.onloadend = () => {
        ...
        // jika ingin upload ke server, tambahkan logic upload di sini
      };
  ...
  const handleSave = () => {
    ...
    // Kirim formData dan imagePreview ke server jika diperlukan
  };
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <div className="md:col-span-2">
              ...
              {isEditing ? (
                ...
                <p className="mt-1 text-lg black-800">{formData.name}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="mt-1 text-lg black-800">{formData.email}</p>
              )}
            </div>
            ...
            <div>
              ...
              {isEditing ? (
                ...
                <p className="mt-1 text-lg black-800">{formData.phone}</p>
              )}
            </div>
            ...
            <div className="md:col-span-2">
              ...
              {isEditing ? (
                ...
                <p className="mt-1 text-lg black-800">{formData.address}</p>
              )}
            </div>
          </div>
